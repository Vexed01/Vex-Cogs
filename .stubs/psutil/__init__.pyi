...
class Process:
    ...
    def memory_percent(self, memtype: str | None = None) -> float: ...
    def cpu_percent(self, interval: int | None = None) -> float: ...

# -------------------------------------------------------------------------------------------------
# some of these can return others but for this cog will only return one thing due to args used
def cpu_percent(interval: int | None = None, percpu: bool = False) -> List[float]: ...
